...
<style>
  ...
  .detail-modal .close-btn { grid-column: 1 / -1; width: 50%; justify-self: center; padding: 10px; background-color: #6c757d; color: white; border: none; border-radius: 6px; font-weight: 600; cursor: pointer; transition: background 0.2s; }
